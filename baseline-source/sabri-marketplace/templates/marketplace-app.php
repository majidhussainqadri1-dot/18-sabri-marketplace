...
<div id="smp-marketplace-root" class="smp-marketplace-root" data-version="<?php echo esc_attr(SMP_VERSION); ?>">
    <noscript><div class="smp-alert">JavaScript is required to use Marketplace.</div></noscript>
    <header class="smp-topbar">
        ...
        <form id="smp-search-form" class="smp-search-form" role="search"><select id="smp-search-category" aria-label="Category"><option value="">All categories</option></select><input id="smp-search-input" type="search" placeholder="Search products, services, stores and brands" autocomplete="off"><button type="submit">Search</button></form>
        <div class="smp-top-actions">
            <button class="smp-icon-button" data-view="saved" title="Saved listings">♡<span id="smp-wishlist-count" class="smp-count" hidden></span></button>
            <button class="smp-icon-button" data-view="chats" title="Chats">💬<span id="smp-chat-count" class="smp-count" hidden></span></button>
            <button class="smp-icon-button" data-view="notifications" title="Notifications">🔔<span id="smp-notification-count" class="smp-count" hidden></span></button>
    ...
    <main class="smp-main">
        <section id="smp-hero" class="smp-hero">
            ...
            <div class="smp-hero-panel"><div><strong>Internal chat</strong><span>Text, photos, files and voice notes</span></div><div><strong>Phone & WhatsApp</strong><span>Required seller and buyer contact details</span></div><div><strong>Direct agreement</strong><span>Offer, pickup and delivery discussion</span></div><div><strong>Safety controls</strong><span>Verification, block, report and moderation</span></div></div>
        </section>
    ...
    <nav class="smp-mobile-nav"><button data-view="home">⌂<span>Home</span></button><button data-view="categories">▦<span>Categories</span></button><button data-view="sell" class="smp-mobile-sell">＋<span>Sell</span></button><button data-view="chats">💬<span>Chats</span></button><button data-view="account">●<span>Account</span></button></nav>
    <div id="smp-modal" class="smp-modal" hidden><div class="smp-modal-backdrop" data-close-modal></div><section class="smp-modal-card" role="dialog" aria-modal="true"><header><h2 id="smp-modal-title">Marketplace</h2><button class="smp-icon-button" data-close-modal>×</button></header><div id="smp-modal-body" class="smp-modal-body"></div></section></div>
