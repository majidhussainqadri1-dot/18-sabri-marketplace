...
assert_true(str_contains($php, "define('MKT_VERSION', '2.0.0')"), 'Runtime version is 2.0.0.');
...
$docs = ['ARCHITECTURE.md','API-EVENT-CONTRACTS.md','SECURITY-PRIVACY.md','MIGRATION-ROLLBACK.md','STAGING-ACCEPTANCE.md','OPERATIONS-RUNBOOK.md','REQUIREMENTS-TRACEABILITY.md'];
