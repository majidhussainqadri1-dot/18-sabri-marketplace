...
final class MKT_Plugin {
    ...
    public function load_textdomain(): void { load_plugin_textdomain('marketplace',false,dirname(MKT_BASENAME).'/languages'); }
    public function init(): void { MKT_DB::maybe_upgrade(); MKT_Routes::register_rewrites(); MKT_Contracts::register_capabilities(); MKT_Integrations::register_providers(); }
}
MKT_Plugin::instance();
